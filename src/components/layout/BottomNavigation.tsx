...
export const BottomNavigation = () => {
  ...
  return (
    <>
      <nav className="flex justify-center items-center text-xs text-center whitespace-nowrap bg-white shadow-[0_-2px_8px_rgba(0,0,0,0.1)] fixed bottom-0 left-0 right-0 h-[58px] z-20">
